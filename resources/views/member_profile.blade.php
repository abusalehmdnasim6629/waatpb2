...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 bg-area" style=" ">
                <div class="col-md-10 offset-md-2 image-text-area" style=" ">
                    <div class="col-md-5 offset-md-4 member-image" style=" ">
                    ...
                    <div class="col-md-6 member-text-area" style=" ">
                        <h4>WELFARE ASSOCIATION OF APPAREL AND TEXTILE PROFESSIONALS OF BANGLADESH</h4>
                        
                        <table style=" ">
                           <tr style=" ">
                           <td style=" ">ASM Nasim</td>
                           </tr>
                           <tr>
                           <td style=" ">web developer</td>
                           </tr>
                           <tr>
                           <td style=" ">Rapples</td>
                           </tr>
                           <tr>
                           <td style=" "><a href="www.waatpb.com" style=" ">www.waatpb.com</a></td>
                           </tr>
                        </table>
                        <br>
                        ...
                        <br>
                        <a href="www.waatpb.com" style=" ">www.waatpb.com</a></td>
                    </div>
                </div>
            </div>
        </div>
