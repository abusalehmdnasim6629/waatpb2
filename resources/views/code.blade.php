					...
					<div class="container">
						...
						<div class="collapse navbar-collapse justify-content-sm-end">
							...
							<li class="nav-item"><a class="nav-link smooth-menu" href="{{URL::to('/')}}" >Home</a></li>
								...
								<li class="nav-item"><a class="nav-link" href="#port-area" >Gallery</a></li>
								<?php 
    ...
    <div>
	 ...
	 ?>
      <div>
        ...
        <form action="{{url('/submit-code')}}" method="post" enctype="multipart/form-data" style="margin-left:30%;padding:20px;">
		{{ csrf_field() }}
