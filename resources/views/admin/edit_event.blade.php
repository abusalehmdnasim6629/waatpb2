			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update-event',$result->event_id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="e_title" value="{{$result->event_title}}" required="" >
							  </div>
							</div>
