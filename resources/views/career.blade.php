                        ...
                        ?>
                          ...
                          <?php } else{ ?>
                            <div style="padding:20px;"class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="{{url::to('/member-registration')}}" style="color: #00aeef;"> <i class="fas fa-arrow-circle-right"></i> Apply For Membership </a>
								<h4>Or</h4>
								<a href="#port-popup" style="color: #00aeef;" id="here"> <i class="fas fa-arrow-circle-right"></i> Login as a member </a>
							</div>
