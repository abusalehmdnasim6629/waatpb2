...
<div class="row pd-2">
		<div class="col-sm-8 mx-auto " style="margin-top:2%;">  
		    ...
		    <img src="{{$pro->cover_image}}" style="width:100%;height:300px;border-top-left-radius:10px;border-top-right-radius:10px;"  class="position-relative"
				alt="avatar">
	        @else
			<img src="https://via.placeholder.com/150" style="width:100%;300px;border-top-left-radius:10px;border-top-right-radius:10px;"  class="position-relative"
				alt="avatar">
			@endif	
				  ...
				  <div class="row">
					...
					<div class="col-sm-12">
						...
						<div class="row my-3">
							...
							<div class="col-sm-4">
								<a class="btn btn-primary btn-sm pd-2" href="{{url::to('/accept-request/'.$p->id)}}">
										Accept
									</a>
									<a class="btn btn-warning btn-sm pd-2" href="{{url::to('/declien-request/'.$p->id)}}">
										Declien
									</a>
