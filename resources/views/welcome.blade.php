					...
					<div class="container">
						...
						<div class="collapse navbar-collapse justify-content-sm-end">
							<ul class="navbar-nav navbar-mobile ml-auto">
								...
								<li class="nav-item"><a class="nav-link smooth-menu" href="#about" data-scrollspy="about">About</a></li>
								<li class="nav-item"><a class="nav-link smooth-menu" href="#service" data-scrollspy="service">Services</a></li>
								<li class="nav-item"><a class="nav-link smooth-menu" href="#history" data-scrollspy="history">History</a></li>
								<li class="nav-item"><a class="nav-link smooth-menu" href="#event" data-scrollspy="event">Event</a></li>
								<li class="nav-item"><a class="nav-link smooth-menu" href="{{URL::to('/career')}}">Career</a></li>
								<li class="nav-item"><a class="nav-link smooth-menu" href="#gallary" data-scrollspy="gallary">Gallery</a></li>
								<?php 
			...
			<div class="container">
				<div class="about-wrapper grid-2">
					<div class="about-left">
						<img src="assets/img/about/about-left.jpg" alt="thumb">
					</div>
					<div class="about-right">
						...
						<div class="about-right-content">
							...
							<p>
								Our vision is to be the best group of the country enriched with exemplary human beings for whom every countryman feels proud.
							</p>
        ...
        <div class="event-area bg de-padding" id="gallary">
			...
			<div class="col-lg-3 col-md-4 col-6" >
				<a href="{{URL::to($g->image)}}" class="d-block mb-4 h-100">
					<img  class="img-fluid img-thumbnail" style="width:200px;height:200px;" src="{{URL::to($g->image)}}" alt="image">
				</a>
			</div>
			<?php } ?>
