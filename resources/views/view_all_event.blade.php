					...
					<div class="container">
						...
						<div class="collapse navbar-collapse justify-content-sm-end">
							<ul class="navbar-nav navbar-mobile ml-auto">
								...
								<li class="nav-item"><a class="nav-link" href="{{URL::to('/full-history')}}">History</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="{{URL::to('/view-all-event')}}">Event</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="{{URL::to('/career')}}">Career</a></li>
								<li class="nav-item"><a class="nav-link" href="{{URL::to('/view-all')}}">Gallery</a>
								</li>
								<?php 
