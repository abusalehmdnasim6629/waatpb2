					...
					<div class="container">
						...
						<div class="collapse navbar-collapse justify-content-sm-end">
							...
							<li class="nav-item"><a class="nav-link smooth-menu" href="{{URL::to('/')}}" >Home</a></li>
								...
								<li class="nav-item"><a class="nav-link" href="#port-area" data-scrollspy="port-area">Gallery</a></li>
								<?php 
                ...
                <div class="tab-pane" id="edit">
                    ...
                    <form role="form">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="{{$pro->member_name}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="email" value="{{$pro->email_address}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Present Organization</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="{{$pro->present_organization}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Designation</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="url" value="{{$pro->designation}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Present Address</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="{{$pro->present_address}}" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="{{$pro->nid}}">
                            </div>
                        </div>
                        <div class="form-group row">
